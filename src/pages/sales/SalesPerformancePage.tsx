...
import { useAdminSalesAgentPerformance } from '@/hooks/api/useAdminSales'
...
export default function SalesPerformancePage() {
  ...
  const query = useAdminSalesAgentPerformance(filters)

  return (
    <section className="min-w-0 space-y-4">
      <PageHeader title="Agent Performance" description="Sales staff metrics for the selected period." />
